...
qp_create_ezfio_from_xyz -b "aug-cc-pvdz_ecp_ncsu" -p "ncsu" -m 1 ${filename}.xyz
...
echo '10000' > ${filename}.ezfio/determinants/n_det_max
...
echo '15000' > ${filename}.ezfio/determinants/n_det_max
