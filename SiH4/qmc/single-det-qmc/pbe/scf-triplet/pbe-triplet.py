...
si_basfile = os.path.join(workdir,'Si.aug-cc-pV5Z.basis')
h_basfile = os.path.join(workdir,'H.aug-cc-pV5Z.basis')
...
hf.max_cycle = 150
hf.verbose=5
#dm=hf.init_guess_by_chkfile('cc-pVnZ/scf.chkfile')
dm=hf.init_guess_by_chkfile('guess/scf.chkfile')
hf.chkfile='pbe-triplet.chkfile'
