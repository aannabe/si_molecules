...
states = ['gs_vertical.csv', 'triplet_vertical.csv', 'singlet_vertical.csv']
#~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
df_triplet = pd.read_csv('triplet_vertical.csv', sep='\s* \s*', engine='python')	# \s*,\s* gets rid of empty spaces in column names
df_singlet = pd.read_csv('singlet_vertical.csv', sep='\s* \s*', engine='python')	# \s*,\s* gets rid of empty spaces in column names
